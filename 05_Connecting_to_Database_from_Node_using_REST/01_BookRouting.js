var routeHandler = require('./01_RouteHandler');
exports.enableRoute = function (url, request, response) {
    ...
    switch (pathname) {
        ...
        case '/books': routeHandler.view_books(request, response);
            break;
        case '/node1.jpg': routeHandler.getImageResponse(request, response);
            break;
        case '/node2.jpg': routeHandler.getImageResponse(request, response);
            break;
        case '/node3.jpg': routeHandler.getImageResponse(request, response);
            break;
        case '/books/view': routeHandler.view_book(request, response);
            break;
        case '/books/download': routeHandler.download_book(request, response);
            break;
        case '/chat': routeHandler.createChat(request, response);
            break;
        default:
