var module = require('./01_DBModule');
var url = require('url');
    ...
    request.on('end', function () {
        ...
        module.authenticateUser(name, password, function (err, data) {
            if (data == "success") {
                ...
                fs.readFile('./01_Details_Book.html', function (err, html) {
                    if (err) {
                        throw err;
                    }
...
exports.display_signup = function (url, request, response) {
    fs.readFile('./01_Signup_Book.html', function (err, html) {
        if (err) {
            throw err;
        }
        response.writeHeader(200, { "Content-Type": "text/html" });
...
exports.display_home = function (url, request, response) {
    response.writeHead(200, { 'Content-Type': 'text/html' });
    fs.readFile('./01_Login_Book.html', function (err, html) {
        if (err) {
            throw err;
        }
        response.writeHeader(200, { "Content-Type": "text/html" });
